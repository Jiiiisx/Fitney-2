...
const faqs = [
  ...
  {
    question: "Apakah data latihan saya akan hilang kalau berhenti berlangganan?",
    answer:
    ...
    <section id="faq" className="relative bg-[#fff9e6] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-4xl font-bold leading-10 tracking-tight text-gray-900">Ada Pertanyaan?</h2>
        ...
        <div className="mt-10 mx-auto max-w-4xl">
            <dl className="space-y-4">
              {faqs.map((faq, index) => (
                <div key={faq.question} className="rounded-lg bg-white shadow-sm border border-gray-200/50">
                  <dt>
                    <button
                  ...
                  {activeIndex === index && (
                    <dd className="px-6 pb-6">
                      <p className="text-base leading-7 text-gray-600 border-t border-gray-200 pt-4 mt-4">{faq.answer}</p>
                    </dd>
                  )}
                </div>
              ))}
