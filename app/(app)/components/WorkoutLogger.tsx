      ...
      <div>
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-gray-800 flex items-center">
            <PlusCircle className="w-6 h-6 mr-3 text-gray-800" />
            Log Today's Workout
          </h2>
          <button
        ...
        >
          ...
          <button
            type="submit"
            className="w-full sm:w-auto flex-grow bg-gray-800 text-white font-bold py-3 px-6 rounded-lg hover:bg-gray-900 transition-colors"
          >
            Log
          </button>
        </form>
