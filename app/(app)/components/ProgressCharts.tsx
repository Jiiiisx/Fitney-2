  ...
  if (active && payload && payload.length) {
    return (
      <div className="p-4 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-lg shadow-lg">
        ...
        <p className="intro" style={{ color: '#1f2937' }}>{`Calories : ${payload[0].value}`}</p>
    ...
    <div className="bg-white p-6 rounded-2xl shadow-sm">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={weeklyTrendData}>
              ...
              <Legend />
              <Area type="monotone" dataKey="calories" stroke="#1f2937" fillOpacity={1} fill="url(#colorCalories)" />
              <Area type="monotone" dataKey="time" stroke="#82ca9d" fillOpacity={1} fill="url(#colorTime)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="font-semibold text-gray-700 mb-2">Activity Distribution</h3>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="font-semibold text-gray-700 mb-2">Strength Balance</h3>
            <ResponsiveContainer width="100%" height={300}>
              <RadarChart cx="50%" cy="50%" outerRadius="80%" data={bodyPartData}>
                <PolarGrid />
                <PolarAngleAxis dataKey="name" />
                <Radar name="Progress" dataKey="progress" stroke="#1f2937" fill="#1f2937" fillOpacity={0.6} />
                <Tooltip />
                <Legend />
              </RadarChart>
            </ResponsiveContainer>
