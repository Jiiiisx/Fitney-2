      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-3">
            <span className="text-xs font-bold bg-yellow-400 text-yellow-900 px-2 py-1 rounded-md">Intermediate</span>
            <span className="text-xs font-bold bg-gray-700 text-gray-200 px-2 py-1 rounded-md">45 min session</span>
          </div>
        </div>
